    ...
    return (
      <div className={styles.article}>
        ...
        <div className={styles.comparisonBlocks}>
          <div className={styles.originalNewsArticle}>
            ...
            <ul className={styles.datelist}>
              ...
              <li className={styles.date}>
                {news &&
                  parseDateTime(
                    news.read_date ? news.read_date : news.timestamp
                  )}
              </li>
            ...
            <p className={styles.img}>
              <img src={news.generated_img_url ? news.generated_img_url?.original : imageSrc} />
            </p>
