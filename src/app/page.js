            ...
            <div className="Main_cont_inner">
              ...
              <div className="M_list_news">
                <ul className="li_news">
                  <li>
                    <a href="#none">
                      <p className="img"><img src="/sample_02.png" /></p>
                      <div className="cnt">
                  ...
                  <li>
                    <a href="#none">
                      <p className="img"><img src="/sample_03.png" /></p>
                      <div className="cnt">
                  ...
                  <li>
                    <a href="#none">
                      <p className="img"><img src="/sample_04.png" /></p>
                      <div className="cnt">
                  ...
                  <li>
                    <a href="#none">
                      <p className="img"><img src="/sample_05.png" /></p>
                      <div className="cnt">
                  ...
                  <li>
                    <a href="#none">
                      <p className="img"><img src="/sample_06.png" /></p>
                      <div className="cnt">
                  ...
                  <li>
                    <a href="#none">
                      <p className="img"><img src="/sample_07.png" /></p>
                      <div className="cnt">
                  ...
                  <li>
                    <a href="#none">
                      <p className="img"><img src="/sample_08.png" /></p>
                      <div className="cnt">
