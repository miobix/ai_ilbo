            ...
            <ul className="li_news">
              ...
              <li>
                <a href="#none">
                  ...
                  <p className="cont">전국보건의료산업노동조합(보건의료노조)가 "전공의들은 진료 거부를 중단하고 환자 곁으로 돌아가야 한다"고 했다.5일 보건의료노조는 성명을 내고 "(정부와) 강대강 대치를 이어갈 것인가...</p>
                  <p className="date">2024-06-05 06:45</p>
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#none">
                  ...
                  <p className="cont">'당심이 민심'이라며 개정됐던 당원 100% 당 대표 투표 규정이 국민의힘에서 폐지될 것으로 보인다.국민의힘 당헌·당규 개정 특별위원회는 4일 첫 회의를 열고 전대 룰 개정 관련 논의를 시작했다.</p>
                  <p className="date">2024-06-05 06:45</p>
                </a>
              </li>
              <li>
