          ...
          <div className="article_section">
            <div className="article">
              ...
              <div className="article_cnts">
                <p>비토르 아브레우 액트지오 고문은 7일 동해 심해 탐사와 관련해 프로젝트 유망성은 상당히 높아 전 세계적인 석유 관련 회사들이 주목하는 상황이라고 밝혔다. 아브레우 고문은 이날 정부세종청사에서 열린 브리핑에서 우리가 분석한 모든 유정이 석유와 가스의 존재를 암시하는 모든 재요소가 갖춰져 있다"며 이같이 말했다.</p>
